...
ii. [Αίτηση εγγραφής (από την Εφαρμογή Ηλεκτρονικής Εγγραφής στην Τριτοβάθμια Εκπαίδευση)](https://eregister.it.minedu.gov.gr/) επιτυχόντα υπογεγραμμένη από τον υποψήφιο (πρέπει να την εκτυπώσετε και να την υπογράψετε στο κάτω μέρος).
...
Μπορούμε να ζητήσουμε ακαδημαϊκή ταυτότητα από την διεύθυνση [https://academicid.minedu.gov.gr/](https://academicid.minedu.gov.gr/) χρησιμοποιόντας στην είσοδο προπτυχιακού φοιτητή το username του email του uom.edu.gr και τον κωδικό που έχουμε. Μπορούμε να ζητήσουμε την ακαδημαϊκή ταυτότητα που χρησιμεύει και ως πάσο για το λεωφορείο.
