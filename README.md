...
Συγκεντρώνω τα έγγραφα από τη σχολή (screenshots κλπ) στο χώρο μου στο [Nextcloud](https://pcloscloud.com/index.php/s/SYcdnLagAK5ZaDT). Εάν έχετε κάτι χρήσιμο να μοιραστείτε με τους συμφοιτητές, στείλτε το.
