...
Σας έχει έρθει ένα mail με οδηγίες. Οι εγγραφές για να δηλώσουμε μαθήματα στο StudentsWeb είναι ανοικτές από 16/10/2020 έως 26/10/2020 και ώρα 22:00.

Τι θα βρείτε:

* [ΒΗΜΑΤΑ ΕΓΓΡΑΦΗΣ](#ΒΗΜΑΤΑ)  
** Είσοδος στην σελίδα register  
** Ενεργοποίηση του ιδρυματικού λογαριασμού  
** Αποστολή εγγράφων απαραίτητων για την εγγραφή  
** Ενεργοποίηση στο uregister  
** Δήλωση μαθημάτων στο StudentsWeb  
** Δήλωση βιβλίων από τον Εύδοξο  
* [ΠΡΟΓΡΑΜΜΑ](#Πρόγραμμα)  
